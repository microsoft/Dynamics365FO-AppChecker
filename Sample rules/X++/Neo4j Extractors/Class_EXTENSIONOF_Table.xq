...
let $extensions := <Extensions>
{
    ...
    where lower-case($attr/AttributeExpression/IntrinsicAttributeLiteral/@FunctionName) = 'tablestr'
...
let $r := <ExtensionsOnMethods>
{
  ...
  return <Record>
      ...
      <Extended name=':END_ID'>{ lower-case("/" || map:get($tables, $e/@ExtendedType) || "/tables/" || $e/@ExtendedType) }</Extended>
