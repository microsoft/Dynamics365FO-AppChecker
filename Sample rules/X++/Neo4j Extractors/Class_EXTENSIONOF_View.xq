...
(: Export form extension information in CSV format :)
...
let $extensions := <Extensions>
{
    ...
    where lower-case($attr/AttributeExpression/IntrinsicAttributeLiteral/@FunctionName) = 'viewstr'
...
let $r := <ExtensionsOnMethods>
{
  ...
  return <Record>
      ...
      <Extended name=':END_ID'>{ lower-case("/" || map:get($forms, $e/@ExtendedType) || "/views/" || $e/@ExtendedType) }</Extended>
