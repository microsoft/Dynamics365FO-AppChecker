...
let $extensions := <Extensions>
{
    ...
    where lower-case($attr/AttributeExpression/IntrinsicAttributeLiteral/@FunctionName) = 'formstr'
...
let $r := <ExtensionsOnMethods>
{
  ...
  return <Record>
      ...
      <Extended name=':END_ID'>{ lower-case("/" || map:get($forms, $e/@ExtendedType) || "/forms/" || $e/@ExtendedType) }</Extended>
