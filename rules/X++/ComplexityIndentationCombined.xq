...
<Diagnostics Category='Mandatory' href='docs.microsoft.com/Socratex/ComplexityIndentation' Version='1.0'>
{
  ...
  return
    <Diagnostic>
      <Moniker>ComplexityIndentation</Moniker>
      ...
      <Message>Method complexity is above {$complexityLimit}{if ($level > $indentationLimit) then concat(" , identation is above ", $indentationLimit)}</Message>
